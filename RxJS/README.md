...
This section is intended as support resource for my **My gentle introduction to RxJS**  talk, here you can find examples and **[Slide](http://slides.com/mattiaocchiuto/an-introduction-to-rxjs/live)** used during the talk.
